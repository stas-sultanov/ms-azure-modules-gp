...
type EntraIDParameters = {
  @description('EntraID Application ClientId')
  applicationClientId: string

  @description('EntraID Application Secret')
  @secure()
  applicationSecret: string

  @description('EntraID Application Scopes')
  applicationScopes: string

  @description('EntraID Application Token Exchange Url')
  applicationTokenExchangeUrl: string?

  @description('EntraID Teanant Id')
  tenantId: string
}
...
@description('EntraID Parameters')
param parameters EntraIDParameters
    ...
    parameters: [
      {
        ...
        value: contains(parameters, 'applicationTokenExchangeUrl') ? parameters.applicationTokenExchangeUrl : null
      }
      {
        key: 'tenantId'
