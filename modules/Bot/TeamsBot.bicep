...
resource BotService_botServices_ 'Microsoft.BotService/botServices@2022-09-15' = {
  ...
  properties: {
    ...
    msaAppTenantId: contains(application, 'tenantId') ? application.tenantId : null
    msaAppMSIResourceId: contains(application, 'MSIResourceId') ? application.MSIResourceId : null
  }
}
